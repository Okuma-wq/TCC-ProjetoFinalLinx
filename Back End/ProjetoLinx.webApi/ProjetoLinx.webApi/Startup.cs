...
using ProjetoLinx.webApi.Repositories;
...
using System.Text;
using ProjetoLinx.webApi.Domains.Services;

namespace ProjetoLinx.webApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ProjetoLinxContext>(x => x.UseSqlServer(Configuration.GetConnectionString("DefaultConnection")));


            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "ProjetoLinx.webApi", Version = "v1" });
            });
            ...
            services.AddTransient<ISenha, Senha>();
            services.AddTransient<IReuniaoRepository, ReuniaoRepository>();
            services.AddTransient<IPropostaService, PropostaService>();
            services.AddTransient<IReuniaoService, ReuniaoService>();
            services.AddTransient<ILoginService, LoginService>();
            services.AddTransient<ITopicoRepository, TopicoRepository>();
            services.AddTransient<ITopicoService, TopicoService>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(
                c => 
                {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "ProjetoLinx.webApi v1");
                    
                    // Comentar para rodar no localhost
